...
\end{equation}
with independent radii and quantized fluxes. It admits the factorized chiral index
\begin{equation}
...
\end{equation}
and transformed to a canonically normalized volume direction and an orthogonal shape direction by diagonalizing the two-field kinetic matrix obtained from Eq.~\eqref{eq:einstframe}.
...
For a product of two Einstein spaces of dimensions $d_1$ and $d_2$, with logarithmic radii $\beta_i=\ln a_i$, the Einstein-frame kinetic matrix in the homogeneous truncation is
\begin{equation}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.98\columnwidth]{benchmark_33.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.98\columnwidth]{benchmark_15.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{amplitude_curve.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{schur_corrections.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.88\textwidth]{observational_comparison.pdf}
